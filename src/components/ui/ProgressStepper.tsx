  ...
  return (
    <nav aria-label="Progress" className="w-full my-8">
      <ol className="flex items-center justify-between px-5 relative">
        ...
        <div className="absolute h-1 bg-secondary-300 left-[5%] right-[5%] top-6" />
        <div 
          className="absolute h-1 bg-gradient-to-r from-primary-600 to-primary-400 left-[5%] top-6 transition-all duration-500 ease-in-out"
          style={{ 
