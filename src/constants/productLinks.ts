...
export const MERCADO_LIBRE_LINKS = {
  ...
  PACK_5_LLAVEROS_NFC_ENVIO_FULL: PRODUCT_INFO.PACK_5_LLAVEROS_NFC_ENVIO_FULL.url,
  PACK_25_LLAVEROS_NFC: PRODUCT_INFO.PACK_25_LLAVEROS_NFC.url,
  PACK_50_LLAVEROS_NFC: PRODUCT_INFO.PACK_50_LLAVEROS_NFC.url
};
...
export const PACK_5_LLAVEROS_NFC_ENVIO_FULL = PRODUCT_INFO.PACK_5_LLAVEROS_NFC_ENVIO_FULL.url;
export const PACK_25_LLAVEROS_NFC = PRODUCT_INFO.PACK_25_LLAVEROS_NFC.url;
export const PACK_50_LLAVEROS_NFC = PRODUCT_INFO.PACK_50_LLAVEROS_NFC.url;
